...
export function textToMarker(color: string) {
  switch (color) {
    ...
    case "black":
      return colorMarkers.blackIcon;
    case "blue":
      return colorMarkers.blueIcon;
    case "grey":
      return colorMarkers.greyIcon;
    case "violet":
      return colorMarkers.violetIcon;
    case "yellow":
      return colorMarkers.yellowIcon;
    case "red":
      return colorMarkers.redIcon;
    case "orange":
      return colorMarkers.orangeIcon;
    case "gold":
      return colorMarkers.goldIcon;
    default:
